...
public class OwnerFragmentAddPartida extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        etFechaInicio.setOnClickListener(v -> showDateTimePickerDialog(etFechaInicio));
        etFechaFin.setOnClickListener(v -> showDateTimePickerDialog(etFechaFin));
    ...
    private void showDateTimePickerDialog(EditText editText) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(getContext(), (view, year1, month1, dayOfMonth) -> {
            TimePickerDialog timePickerDialog = new TimePickerDialog(getContext(), (timeView, hourOfDay, minute1) -> {
                String selectedDate = dayOfMonth + "/" + (month1 + 1) + "/" + year1 + " " + hourOfDay + ":" + minute1;
